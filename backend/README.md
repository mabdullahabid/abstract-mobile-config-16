...
## Project Structure
    ...
    ├── abstract_mobile_config_16  # Django project configurations
...
1. Clone this repo and `cd abstract_mobile_config_16`
...
2. Clone this repo and `cd abstract_mobile_config_16`
