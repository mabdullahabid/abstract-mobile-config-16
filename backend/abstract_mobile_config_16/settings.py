"""
Django settings for abstract_mobile_config_16 project.
...
ROOT_URLCONF = 'abstract_mobile_config_16.urls'
...
WSGI_APPLICATION = 'abstract_mobile_config_16.wsgi.application'
